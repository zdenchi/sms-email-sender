...
function EmailVerification({ token, confirmUrl }) {
  const baseUrl = `https://${process.env.BASE_URL}`;
  const { html } = mjml2html(
  `<mjml>
    <mj-head>
      <mj-preview>Email confirmation code</mj-preview>
    ...
    <mj-body css-class="bg">
      <mj-wrapper css-class="wrapper" padding="0" background-color="#fff">
        ...
        <mj-section>
          <mj-column>
            <mj-text font-weight="500" font-size="18px">Confirm your email address.</mj-text>
            <mj-text font-size="14px" line-height="1.5">To confirm your email address, enter the confirmation code on the website or click the button <strong>&#171;Confirm&#187;</strong>.</mj-text>
          </mj-column>
        </mj-section>
        ...
        <mj-section padding-top="0">
          <mj-column>
            ...
            <mj-button background-color="#fbbf24" color="#000" padding-top="20px" font-weight="500" text-transform="uppercase" border-radius="8px" href="${confirmUrl}"> Confirm </mj-button>
          </mj-column>
        </mj-section>
